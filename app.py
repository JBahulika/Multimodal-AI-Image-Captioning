...
@st.cache_resource
def load_model():
    """Load the CLIP model and processor (lighter version for deployment)."""
    # 🔽 switched from laion/CLIP-ViT-H-14-laion2B-s32B-b79K to lighter base model
...
if uploaded_file is not None:
    ...
    with col1:
        ...
        st.image(image, use_column_width=True)  # ✅ fixed parameter
